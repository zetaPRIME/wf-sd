...
A Steam Input profile for Warframe on Steam Deck, compatible with Echoes of Duviri. Fixes numerous issues with the official configuration, and uses a combination of Steam Input actions, mouse and keyboard bindings to provide a much more fluid and integrated experience and take full advantage of the Deck's input capabilities.
